...
public class GraphVisualize : MonoBehaviour
{
    ...
    public void UpdateOnGUI_Pos(float? frequency , float? damping , float? Responsiveness,float? DeltaTime,SelectedAlgorithm selectedAlgorithm)
    {
    ...
    public void UpdateOnGUI_Rot(float? frequency , float? damping , float? Responsiveness,float? DeltaTime,SelectedAlgorithm selectedAlgorithm)
    {
    ...
    public void UpdateOnGUI_Scale(float? frequency , float? damping , float? Responsiveness,float? DeltaTime,SelectedAlgorithm selectedAlgorithm)
    {
